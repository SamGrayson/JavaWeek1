...
// Put your answer below -------------------------
  ...
  [C]... The 1 miliseconds delay of changing the letter variable to "Y" takes place after the variable is changed to "Z" and then
  logged due to the face that the second statement has no delay.
...
Becasue a undefined value is being added to the "speed" variable which is 0, a NaN value is given.
